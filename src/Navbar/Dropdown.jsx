...
const categories = {
  '대한민국': ['전체', '서울 · 경기', '강원도', '경상북도', '경상남도', '전라북도', '전라남도', '제주도', '충청북도', '충청남도'],
  '남아메리카': ['전체', '브라질', '볼리비아', '아르헨티나', '칠레', '페루', '기타'],
  '북아메리카': ['전체', '미국 · 동부', '미국 · 서부', '멕시코', '캐나다', '기타'],
  '아시아': ['전체', '베트남', '일본', '중국', '필리핀', '기타'],
  '아프리카': ['전체', '모로코', '이집트', '기타'],
  '유럽': ['전체', '동유럽', '북유럽', '서유럽', '기타'],
  '중동': ['전체', '사우디', '터키', '기타'],
  '호주': ['전체', '하와이', '호주', '기타']
};
